...
\begin{enumerate}
    ...
    \item \textbf{GRPO Reinforcement Learning:} We explored reinforcement-learning-based optimization, though we ultimately abandoned full training due to severe compute constraints.
